  ...
  return (
    <SafeAreaView>
      ...
      <View
        style={{
          ...styles.container,
          backgroundColor: colors.background == '#171717' ? 'black' : 'white',
        }}>
        <Text
          style={{
            ...styles.txt,
      ...
      <TextInput
        ...
        secureTextEntry={!secureTextEntry2 ? false : true}
        right={
          <TextInput.Icon
      ...
      <TextInput
        ...
        secureTextEntry={!secureTextEntry3 ? false : true}
        right={
          <TextInput.Icon
            name={!secureTextEntry3 ? 'eye' : 'eye-off'}
            onPress={() => {
      ...
      <TouchableOpacity
        ...
        <Text
          style={{color: '#00E556', fontWeight: 'bold'}}
